...
public class CreateOrderService implements ICreateOrderService {
    ...
    @Override
    public OrderItemEntity createOrder(BusinessAggregate businessAggregate) throws Exception {

        StrategyHandler<BusinessAggregate, DynamicContext, OrderItemEntity> root = factory.getTreeRoot();
